...
const RunPanel = observer(() => {
    ...
    const { BOT_BUILDER, CHART, BOTS, DASHBOARD, COPY_TRADING } = DBOT_TABS;
    ...
    const show_run_panel = [BOT_BUILDER, CHART, BOTS, DASHBOARD, COPY_TRADING].includes(active_tab) || active_tour;
