...
export const APP_IDS = {
    LOCALHOST: 127478, // Default for local dev
    TMP_STAGING: 127478,
    STAGING: 127478, // TODO: Update with real staging ID if different
    STAGING_BE: 127478,
    STAGING_ME: 127478,
    PRODUCTION: 127478, // Example production ID - needs verification
    PRODUCTION_BE: 127478,
    PRODUCTION_ME: 127478,
};
